<div class="rounded-[6px] p-[18px] bg-cover bg-center bg-no-repeat" style="background-image: url({{ $course->image }})">
	<div class="mb-[10px] text-[24px] font-bold text-white">{{ $course->name }}</div>
