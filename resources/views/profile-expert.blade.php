...
@section('content')
	...
	<div class="h-screen flex justify-center items-center px-2 bg-gradient-to-tr from-sky-300 via-sky-400 to-blue-500">
		<div class="max-w-lg mx-auto bg-white shadow-lg rounded-lg overflow-hidden">

			<div class="py-4 px-6">
				<h2 class="text-4xl font-bold text-gray-800">Скоро</h2>
				<p class="mt-2 text-lg text-gray-600">Мы прилагаем все усилия, чтобы предоставить вам удивительный веб-сайт. Следите за обновлениями!</p>
			</div>
			<div class="py-4 px-6">
				<div class="flex flex-wrap gap-4 justify-center items-center">
					<div class="border rounded-lg px-4 py-2">
						<div id="days" class="font-bold font-mono text-2xl text-gray-800"></div>
					</div>
					<div class="border rounded-lg px-4 py-2">
						<div id="hours" class="font-bold font-mono text-2xl text-gray-800"></div>
					</div>
					<div class="border rounded-lg px-4 py-2">
						<div id="minutes" class="font-bold font-mono text-2xl text-gray-800"></div>
					</div>
					<div class="border rounded-lg px-4 py-2">
						<div id="seconds" class="font-bold font-mono text-2xl text-gray-800"></div>
					</div>
				</div>
			</div>
		</div>
