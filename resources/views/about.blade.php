		...
		<div class="bg-cover bg-center bg-no-repeat" style="background-image: url({{ asset('assets/img/about_us.png') }})">
			<div class="mx-auto w-[1080px] py-[90px]">
				<div class="flex flex-col items-center text-white text-center">
					...
					<div class="mb-[30px] font-light">Приветствуем Вас на нашей профориентационной платформе Profed! Мы – команда профессионалов, которые знают, насколько важно выбрать свою будущую профессию правильно. Мы предлагаем инновационное решение для тех, кто хочет узнать больше о своих профессиональных интересах и возможностях. Наша миссия – помочь людям стать счастливыми экспертами. Мы верим, что каждый человек имеет уникальный набор навыков и интересов, и что настоящее удовлетворение от работы может быть достигнуто только тогда, когда эти качества сочетаются в выбранной профессии.</div>
