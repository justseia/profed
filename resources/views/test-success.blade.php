	...
	<div class="mx-auto w-[1080px] py-[45px] text-center">
		<div class="mb-[32px] flex justify-center rounded-[10px] shadow-xl">
			<div class="text-center">
				<img src="https://shorturl.at/blrR1" class="mb-[28px] h-[250px] w-[1080px] rounded-t-[10px] object-cover object-center" />
				<div class="mb-[30px] text-[32px]">Вам подходит сфера!</div>
				<div class="mb-[42px] text-[36px] text-[#65C680]">IT программирование</div>
			</div>
		</div>
